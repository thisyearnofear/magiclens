...
RUN cd /deployment/services && uv add pydantic httpx httpcore h11 pyjwt python-dotenv dotenv fastapi uvicorn requests beautifulsoup4 psycopg-pool psycopg boto3 python-multipart loguru
